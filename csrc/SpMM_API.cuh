...
static void SpMM_SplitK_Kernel_Ex_bitmap_v3(cudaStream_t stream, const half *A, const half *Compressed_A, const int *TileOffsets,
                                            ...
                                            const half *Compressed_B, const int *TileOffsets_B, const int *TileOffsets_Median_B,
    ...
    static int SHMEM_SZ = max((TilingConfig::TILE_N * TILE_K) * sizeof(half) * 2 + 2304 * sizeof(half) +
                                  10*(TilingConfig::TILE_BITMAP_M_V3 * TilingConfig::TILE_BITMAP_K_V3) * sizeof(uint64_t),
...
cudaError_t SpMM_SplitK_API_bitmap_v3(cudaStream_t stream, const half *A, const half *Compressed_A, const int *TileOffsets,
    ...
    case 8:
        SpMM_SplitK_Kernel_Ex_bitmap_v3<TilingConfigBitmapV3<4, 1, 1, 1>>(
            stream, A, Compressed_A, TileOffsets, TileOffsets_Median, bitmap, max_nnz_intile, B, Compressed_B, TileOffsets_B, TileOffsets_Median_B,
            bitmap_B, max_nnz_intile_B, SpMM_SplitK_OutputPTR, M_Global, N_Global, K_Global, Split_K);
        break;
    case 16:
    ...
    default:
        if (N_Global % 128 == 0)
            SpMM_SplitK_Kernel_Ex_bitmap_v3<TilingConfigBitmapV3<4, 1, 4>>(
                stream, A, Compressed_A, TileOffsets, TileOffsets_Median, bitmap, max_nnz_intile, B, Compressed_B, TileOffsets_B,
                TileOffsets_Median_B, bitmap_B, max_nnz_intile_B, SpMM_SplitK_OutputPTR, M_Global, N_Global, K_Global, Split_K);
        else {
